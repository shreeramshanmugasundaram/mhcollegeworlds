...
const namedict = {
  ...
  2129: { name: `M.S. Bidve Engineering College, Latur`, dist: "Latur" },
  2130: {
  ...
  2136: { name: `Aditya Engineering College , Beed`, dist: "Beed" },
  2137: {
  ...
  3445: {
    name: `Vishvatmak Jangli Maharaj Ashram Trust's Vishvatmak Om Gurudev College of Engineering, Mohili-Aghai, Shahpur.`,
    dist: "Thane",
  },
  3447: {
  ...
  3475: { name: `A. P. Shah Institute of Technology, Thane`, dist: "Thane" },
  3477: {
  ...
  4025: { name: `Government College of Engineering, Nagpur`, dist: "Nagpur" },
  4104: {
  ...
  4147: { name: `K.D.K. College of Engineering, Nagpur`, dist: "Nagpur" },
  4151: {
  ...
  4649: { name: `Bajaj Institute of Technology, Wardha`, dist: "Wardha" },
  5003: {
    name: `University Institute of Chemical Technology, North Maharashtra University, Jalgaon`,
    dist: "Jalgaon",
  },
  5004: { name: `Government College of Engineering, Jalgaon`, dist: "Jalgaon" },
  5103: {
  ...
  5107: {
    name: `Shri Gulabrao Deokar College of Engineering, Jalgaon`,
    dist: "Jalgaon",
  },
  5108: {
  ...
  5172: { name: `R. C. Patel Institute of Technology, Shirpur`, dist: "Dhule" },
  5173: {
  ...
  6005: { name: `Government College of Engineering, Karad`, dist: "Satara" },
  6006: { name: `College of Engineering, Pune`, dist: "Pune" },
  6007: { name: `Walchand College of Engineering, Sangli`, dist: "Sangli" },
  6028: {
  ...
  6146: { name: `MIT Academy of Engineering,Alandi, Pune`, dist: "Pune" },
  6149: {
  ...
  6185: { name: `Sinhagad Institute of Technology, Lonavala`, dist: "Pune" },
  6187: {
  ...
  6265: { name: `Walchand Institute of Technology, Solapur`, dist: "Solapur" },
  6267: {
  ...
  6609: { name: `Jaihind College Of Engineering,Kuran`, dist: "Pune" },
  6622: { name: `ISBM College Of Engineering Pune`, dist: "Pune" },
  6625: {
  ...
  6755: { name: `JSPM Narhe Technical Campus, Pune.`, dist: "Pune" },
  6756: {
    name: `Fabtech Technical Campus College of Engineering and Research, Sangola`,
    dist: "Solapur",
  },
  6757: { name: `Yashoda Technical Campus, Wadhe, Satara.`, dist: "Satara" },
  6758: {
  ...
  6768: { name: `P.K. Technical Campus, Pune.`, dist: "Pune" },
  6769: {
  ...
  6772: { name: `NBN Sinhgad Technical Institutes Campus, Pune`, dist: "Pune" },
  6780: {
  ...
  6781: { name: `Bhagwant Institute of Technology, Barshi`, dist: "Solapur" },
  6782: {
  ...
  6808: { name: `Keystone School of Engineering, Pune`, dist: "Pune" },
  6815: {
...
//functions
//1)function selecting the dict****returns the array of object i.e. dict
function selectDict(branchVariable) {
...
//2)sort by districts to dict (returns array of object i.e. dict)
function sortBydistrict(objdict, firstDist, secondDist, thirdDist) {

  const newdict = [];
  for (let i = 0; i < objdict.length; i++) {
    if (
      objdict[i]["dist"] === firstDist ||
      objdict[i]["dist"] === secondDist ||
      objdict[i]["dist"] === thirdDist
    ) {
      newdict.push(objdict[i]);
    }
  }
  return newdict;
}
//this function will produce dict with new proper cutoff accepts the input
//this funtion will give you othercutoff and homecutoff for function addcutoff in form of list like [homecutoff,othercutoff]
//
function h_or_o(gender,cat){
  ...
  console.log(homecutoff,othercutoff,gender)
  return([homecutoff,othercutoff])
  
}
//fuction for producing final dict with new properety cutoff(return array of object i.e.dict)
function addCutoff(dict, district, othercutoff, homecutoff) {
  for (let i = 0; i < dict.length; i++) {
    const firstValue = Object.values(dict)[i];
    //store the element in object array

    const secondVal = Object.values(firstValue)[17];
    //store the 17th property of object i.e.dist
    //here district is consider to be home district

    if (secondVal == district) {
      // changeindex=i;
      firstValue.cutoff = Object.values(firstValue)[homecutoff];
      //homecutoff should be a index position of homedistrictcutoff of that category
      //eg category is open and gender in male so category becomes gopen
    } else {
      firstValue.cutoff = Object.values(firstValue)[othercutoff];
    }
  }
  return dict;
}
//arrange dict into discending order of your cutoff
function arrangeIndiscending(dict) {
  dict.sort((a, b) => {
    return b.cutoff - a.cutoff;
  });
  return dict;
}
//3)catlist produce returnslist
function produceCatlist(dict) {
  return dict.map(({ cutoff }) => cutoff);
}

//nearest number function for array returns index of nearest number in array
function nearest_number(arr, inputnum) {
  let checklist = [];
  function addtolist(item) {
    let b = Math.abs(item - inputnum);
    checklist.push(b);
  }
  arr.forEach(addtolist);
  return checklist.indexOf(Math.min(...checklist));
}

function produceDtecodes(dict, index) {
  let finalList = [];
  if (dict.length < 15) {
    return dict.map((college) => college.dte);
  } else {
    if (index + 7 > dict.length) {
      for (let i = dict.lenght - 14; i < dict.lenght - 1; i++) {
        finalList.push(dict[i].dte);
      }
    } else if (index - 7 < 1) {
      for (let i = 0; i < 14; i++) {
        finalList.push(dict[i].dte);
...
// //produces list of dte codes
// function produceDtecodes(index,dict){
//     console.log("inside")
//     console.log(index,dict)
//     if(dict.length<30){
//         console.log('test1')
//         for(let i=0;i<dict.length-1;i++){
//             listofdte.push(Object.values(Object.values(dict)[i])[0]);
//         }
//         return(listofdte);
//     }
//     else{
//         console.log("inside else")
//     if (index + 15 > dict.length){
//         console.log('test2')
//         lastindex = dict.length-1
//         firstindex=dict.length-29
//         for(let i=firstindex;i<lastindex+15;i++){
//             listofdte.push(Object.values(Object.values(dict)[i])[0])
//     }
//     if (index-15 < 1){
//         console.log('test3')
...
// dicttt=(sortBydistrict(civil,'Akola','Amravati','Solapur'))
// homec=h_or_o('male','open')[0]
// othhomec=h_or_o('male','open')[1]
// discendingdict=(arrangeIndiscending(addCutoff(dicttt,'Akola',h_or_o('male','open')[1],h_or_o('male','open')[0])))
// list1=produceCatlist(discendingdict)
// console.log(list1.length)
// console.log(discendingdict.length)
// indexx=nearest_number(list1,22)
// console.log(indexx)
// list2=produceDtecodes(indexx,discendingdict)
// console.log(list2)
//this code will give you the list of dte code and you can access a data afterwards
export default {
  civil,
  comp,
  entc,
